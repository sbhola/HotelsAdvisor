                ...
                <tr>\
                            ...
                            <div class="selector-filter">\
                                <table width="100%" border="0">\
                                    <tr>\
                                       <td>\
                                            <div>\
                                                <input type="text" class="filter-input"><i class="mrs icon-search searchicon_mt4 pointer"></i>\
                                            </div>\
                                        </td>\
                                    </tr>\
                                </table>\
                    ...
                    <td width="50%">\
                        <div class="selector-chosen">\
                            \
                            <div class="selector-filter right" style="margin-top:25px !important">\
                               <p style="text-align:left !important;" >Selected Airelines \
                            </div>\
