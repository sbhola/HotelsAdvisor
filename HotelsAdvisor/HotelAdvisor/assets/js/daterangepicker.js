...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
               ...
               // '<div class="ranges">' +
                  '<div class="range_inputs">' +
                   // '<div style="border-top:1px solid #e0e0e0; padding-top:10px; padding-bottom:6px;">' +
                    ...
                    '</div>' +
                   // '<button class="' + this.applyClass + ' applyBtn btn-large" disabled="disabled ">' + this.locale.applyLabel + '</button>&nbsp;' +
                //    '<button class="' + this.cancelClass + ' cancelBtn mls btn-large">' + this.locale.cancelLabel + '</button>' +
                  '</div>' +
               // '</div>' +
              '</div>';
        ...
        this.container.find('.ranges').on('click', '.available', $.proxy(this.clickApply, this));
