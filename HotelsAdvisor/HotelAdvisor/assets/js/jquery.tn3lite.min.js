 ...
 */
(function(h){function b(g){var l=g.skinDir+"/"+g.skin,k=f[l];if(k)k.loaded?a.call(this,g,k.html):k.queue.push({c:this,s:g});else{f[l]={loaded:false,queue:[{c:this,s:g}]};h.ajax({url:l+".html",dataType:"text",success:function(m){var t=f[l];t.loaded=true;t.html=m;for(m=0;m<t.queue.length;m++)a.call(t.queue[m].c,t.queue[m].s,t.html)},dataFilter:function(m){return m=m.substring(m.indexOf("<body>")+6,m.lastIndexOf("</body>"))},error:function(){if(g.error){var m=h.Event("tn3_error");m.description="tn3 skin load error";
g.error(m)}}})}return this}function a(g,l){this.each(function(){for(var k=h(this),m,t,u=l.indexOf("<img src=");u!=-1;){u+=10;t=l.indexOf('"',u);m=g.skinDir+"/"+l.substring(u,t);l=l.substr(0,u)+m+l.substr(t);u=l.indexOf("<img src=",u)}k.append(l);k.data("tn3").init(k,g.fullOnly)})}function c(g){var l=[],k=g.children(".tn3.album"),m,t;if(k.length>0)k.each(function(u){m=h(this);l[u]={title:m.find(":header").html()};h.extend(l[u],d(m));if(t=e(m)){l[u].imgs=t;if(!l[u].thumb)l[u].thumb=l[u].imgs[0].thumb}});
else if(t=e(g))l[0]={imgs:t};return l}function e(g){var l=[],k,m;k=g.children("ol,ul").children("li");if(k.length>0)k.each(function(t){m=h(this);$firsta=m.find("a:not(.tn3 > a)").filter(":first");l[t]={title:m.find(":header").filter(":first").html()};if($firsta.length>0){l[t].img=$firsta.attr("href");l[t].thumb=$firsta.find("img").attr("src")}else l[t].img=m.find("img").filter(":first").attr("src");h.extend(l[t],d(m));l[t].alt=m.find("img").filter(":first").attr("alt")||l[t].title});else{k=g.find("img");
k.each(function(t){m=h(this);$at=m.parent("a");l[t]=$at.length==0?{title:m.attr("title"),img:m.attr("src")}:{title:m.attr("title"),img:$at.attr("href"),thumb:m.attr("src")};l[t].alt=m.attr("alt")||l[t].title})}if(l.length==0)return null;return l}function d(g){var l={};g=g.children(".tn3");var k;h.each(g,function(){k=h(this);l[k.attr("class").substr(4)]=k.html()});return l}function i(g){h('a[href^="#tn3-'+g+'"]').click(function(l){var k=n[g];l=h(l.currentTarget).attr("href");l=l.substr(l.indexOf("-",
5)+1);l=l.split("-");switch(l[0]){case "next":k.cAlbum!=null&&k.show("next",l[1]=="fs");break;case "prev":k.cAlbum!=null&&k.show("prev",l[1]=="fs");break;default:k.cAlbum!=parseInt(l[0])?k.showAlbum(parseInt(l[0]),parseInt(l[1]),l[2]=="fs"):k.show(parseInt(l[1]),l[2]=="fs")}})}function j(){if(n.length==0){var g=h(".tn3gallery");g.length>0&&g.tn3({})}}if(/1\.(0|1|2|3|4)\.(0|1)/.test(h.fn.jquery)||/^1.1/.test(h.fn.jquery)||/^1.2/.test(h.fn.jquery)||/^1.3/.test(h.fn.jquery))alert("tn3gallery requires jQuery v1.4.2 or later!  You are using v"+
h.fn.jquery);else{var f={},n=[];h.fn.tn3=function(g){h.each(["skin","startWithAlbums","external"],function(l,k){var m=k.split(".");if(m.length>1&&g[m[0]])delete g[m[0]][m[1]];else delete g[k]});g=h.extend(true,{},h.fn.tn3.config,g);if(g.skin!=null)if(typeof g.skin=="object"){g.skinDir+="/"+g.skin[0];if(g.cssID==null)g.cssID=g.skin[0];g.skin=g.skin[1]}else g.skinDir+="/"+g.skin;else{g.skin="tn3";g.skinDir+="/tn3";h.fn.tn3.dontLoad=true}if(g.cssID==null)g.cssID=g.skin==null?"tn3":g.skin;this.each(function(){var l=
h(this);g.fullOnly?l.hide():l.css("visibility","hidden");var k=g.data?g.data:c(l);k=n.push(new h.fn.tn3.Gallery(k,g))-1;l.data("tn3",n[k]);for(var m=0;m<h.fn.tn3.plugins.length;m++)h.fn.tn3.plugins[m].init(l,g,n[k]);l.empty();i(k)});h.fn.tn3.dontLoad?a.call(this,g,g.skinDefault):b.call(this,g);return this};h.fn.tn3.plugins=[];h.fn.tn3.plugIn=function(g,l){h.fn.tn3.plugins.push({id:g,init:l})};h.fn.tn3.version="1.4.0.93";h.fn.tn3.config={data:null,skin:null,skinDir:"skins",skinDefault:'<div class="tn3-gallery"><div class="tn3-image"><div class="tn3-text-bg"><div class="tn3-image-title"></div><div class="tn3-image-description"></div></div><div class="tn3-next tn3_v tn3_o"></div><div class="tn3-prev tn3_v tn3_o"></div><div class="tn3-preloader tn3_h tn3_v"><img src="../images/preload.gif"/></div><div class="tn3-timer"></div></div><div class="tn3-controls-bg tn3_rh"><div class="tn3-sep1"></div><div class="tn3-sep2"></div><div class="tn3-sep3"></div></div><div class="tn3-thumbs"></div><div class="tn3-fullscreen"></div><div class="tn3-show-albums"></div><div class="tn3-next-page"></div><div class="tn3-prev-page"></div><div class="tn3-play"></div><div class="tn3-count"></div><div class="tn3-albums"><div class="tn3-inalbums"><div class="tn3-album"></div></div><div class="tn3-albums-next"></div><div class="tn3-albums-prev"></div><div class="tn3-albums-close"></div></div></div>',
cssID:null};h.fn.tn3.translations={};h.fn.tn3.translate=function(g,l){if(l)h.fn.tn3.translations[g]=l;else{var k=h.fn.tn3.translations[g];return k?k:g}};h(function(){setTimeout(j,1)})}})(jQuery);
...
"http://tn3gallery.com");var f=this;this.timer=new h.fn.tn3.Timer(this.$c,this.config.delay,this.config.timerSteps);this.$c.bind("tn3_timer_end",function(){f.show("next")});this.special={rv:[],rh:[],v:[],h:[],vi:[],hi:[],o:[],x:{}};this.parseLayout();this.center();h.each(this.items,function(n,g){switch(n){case "next":g.click(function(k){f.show("next");k.stopPropagation()});g.attr("title",f.t("Next Image"));break;case "prev":g.click(function(k){f.show("prev");k.stopPropagation()});g.attr("title",f.t("Previous Image"));
...
f.trigger(k.type,k)});g.hide();break;case "play":g.click(function(k){var m={id:"play",execute:true};f.trigger("control",m);if(f.isPlaying){if(m.execute){f.timer.stop();g.removeClass(f.config.cssID+"-play-active");g.attr("title",f.t("Start Slideshow"))}f.isPlaying=false}else{if(m.execute){f.timer.start();g.addClass(f.config.cssID+"-play-active");g.attr("title",f.t("Stop Slideshow"))}f.isPlaying=true}k.stopPropagation()});g.attr("title",f.t("Start Slideshow"));break;case "count":break;case "albums":f.albums=
new h.fn.tn3.Albums(f.data,g,f.config.cssID);g.hide();g.bind("albums_binit",function(k){f.trigger(k.type,k)}).bind("albums_click",function(k){f.showAlbum(k.n);f.trigger(k.type,k)}).bind("albums_init",function(k){f.timer.pause(true);f.trigger(k.type,k)}).bind("albums_error",function(k){f.trigger("error",k)}).bind("albums_close",function(){f.timer.pause(false)});break;case "album":break;case "albums-next":f.albums&&f.albums.setControl("next",g);g.attr("title",f.t("Next Album Page"));break;case "albums-prev":f.albums&&
f.albums.setControl("prev",g);g.attr("title",f.t("Previous Album Page"));break;case "albums-close":f.albums&&f.albums.setControl("close",g);g.attr("title",f.t("Close"));break;case "show-albums":g.click(function(k){f.items.albums&&f.albums.show(0,f.cAlbum,false,true);k.stopPropagation()});g.attr("title",f.t("Album List"));break;case "fullscreen":g.click(function(k){var m={id:"fullscreen",execute:true};f.trigger("control",m);m.execute&&f.fullscreen(true);k.stopPropagation()});g.attr("title",f.t("Maximize"));
break;default:f.special.x[n]&&g.click(function(k){var m=!f.items[f.special.x[n]].is(":visible"),t={id:n,execute:true,active:m};f.trigger("control",t);if(t.execute){m?g.addClass(f.config.cssID+"-"+n+"-active"):g.removeClass(f.config.cssID+"-"+n+"-active");f.items[f.special.x[n]].toggle()}k.stopPropagation()})}});if(this.config.width!==null||this.config.height!==null){if(this.config.width==null)this.config.width=this.config.initValues.width;if(this.config.height==null)this.config.height=this.config.initValues.height;
this.resize(this.config.width,this.config.height)}j=Math.min(this.config.iniAlbum,this.data.length-1);this.config.responsive!==false&&this.initResponsive(this.config.responsive);this.initialized=true;this.config.startWithAlbums&&this.data.length>1&&this.items.albums?this.albums.show():this.showAlbum(j,this.config.iniImage);this.config.isFullScreen&&this.onFullResize();if(this.config.autoplay)this.items.play?this.items.play.click():this.timer.start();this.trigger("init")}},parseLayout:function(){var d=
this.items={},i=this.config,j=i.active,f=i.inactive,n=i.cssID.length+1,g=this,l=/MSIE/.test(navigator.userAgent),k,m;this.$c.find("div[class^='"+i.cssID+"-']").each(function(){k=h(this);m=k.attr("class").split(" ")[0].substr(n);if(h.inArray(m,f)!=-1)k.remove();else if(j.length==0||h.inArray(m,j)!=-1)d[m]=k;else m!="gallery"&&k.remove();if(k.parent().hasClass(i.cssID+"-image")){if(!g.$inImage){g.$inImage=h('<div class="tn3-in-image"></div>');k.parent().append(g.$inImage);if(l){var u=h("<div />");u.css("background-color",
"#fff").css("opacity",0).css("width","100%").css("height","100%");u.appendTo(g.$inImage)}g.$inImage.css("position","absolute").width(d.image.width()).height(d.image.height())}k.appendTo(g.$inImage)}this.className.indexOf("tn3_")!=-1&&g.addSpecial(m,this.className)});$cm=this.$c;h.each(["albums","album","album-next","album-prev","show-albums","timer"],function(u,q){delete d[q];$cm.find("."+i.cssID+"-"+q).remove()});var t=h('<div title="Powered by TN3 Gallery"></div>');t.css("position","absolute").css("background-image",
"url('"+this.config.skinDir+"/tn3.png')").css("background-position","-258px -7px").css("bottom","14px").css("right","53px").css("cursor","pointer").width(40).height(18);t.appendTo(this.$c.find("."+i.cssID+"-gallery"));t.click(function(){window.location="http://tn3gallery.com"}).hover(function(){h(this).css("background-position","-258px -45px")},function(){h(this).css("background-position","-258px -7px")})},addSpecial:function(d,i){for(var j=i.split(" "),f,n=0;n<j.length;n++){f=j[n].split("_");if(f[0]==
"tn3")if(f[1]=="x")this.special.x[d]=f[2];else{this.special[f[1]].push(d);if(f[1]=="rh"||f[1]=="rv")this.config.initValues[d]={w:this.items[d].width(),h:this.items[d].height()}}}},initHover:function(d,i){var j=this;d.hover(function(){d.addClass(j.config.cssID+"-"+i+"-over")},function(){d.removeClass(j.config.cssID+"-"+i+"-over")})},setTextValues:function(d,i){var j,f,n,g=i+"-";for(n in this.items)if(n.indexOf(g)==0){j=n.substr(g.length);if(j!="info"&&j!="prev"&&j!="next"){f=i=="image"?this.data[this.cAlbum].imgs[this.n]:
this.data[this.cAlbum];if(!f||f[j]==undefined){f={};f[j]=""}else f[j]=h.trim(f[j]);j={field:j,text:f[j],data:f};this.trigger("set_text",j);if(d||j.text==undefined||j.text.length==0){this.items[n].html("");this.items[n].hide()}else{this.items[n].html(j.text);this.items[n].show()}}}},show:function(d,i){this.timer.stop();this.showInit=true;this.imager&&this.imager.show(d);i&&this.fullscreen()},setAlbumData:function(d,i){if(i)this.trigger("error",{description:i});else{for(var j=0,f=d.length;j<f;j++)this.data.push(d[j]);
this.$c&&this.init(this.$c,this.config.fullOnly)}},setImageData:function(d,i,j){if(j)this.trigger("error",{description:j});else{this.displayPreloader(false);d={data:d};this.trigger("image_data",d);this.data[i].imgs=d.data;if(this.cAlbum==i)this.rebuild(d.data,this.showInit?0:this.config.iniImage)}},showAlbum:function(d,i,j){if(this.initialized){if(d>this.data.length)return;this.timer.stop();this.cAlbum=d;this.albums&&this.albums.hide();if(this.data[this.cAlbum].imgs===undefined)if(this.loader){this.loader.getImages(this.data[this.cAlbum].adata,
this.cAlbum);this.displayPreloader(true)}else this.trigger("error",{description:"Wrong album id"});else this.rebuild(this.data[this.cAlbum].imgs,i)}else{this.config.iniAlbum=d;this.config.iniImage=i;this.init(this.$c,false)}j&&this.fullscreen()},rebuild:function(d,i){if(this.items.thumbs)if(this.thumbnailer)this.thumbnailer.rebuild(d);else this.thumbnailer=new h.fn.tn3.Thumbnailer(this.items.thumbs,d,this.config.thumbnailer);if(this.items.image)if(this.imager)this.imager.rebuild(d);else this.imager=
new h.fn.tn3.Imager(this.items.image,d,this.config.image);this.setTextValues(true,"image");this.setTextValues(false,"album");this.trigger("rebuild",{album:this.cAlbum});this.show(i==null?0:i)},showElements:function(d){if(this.areHidden){var i=this,j;h.each(this.special.o,function(f,n){j=i.items[n];j.show();if(d&&h.support.opacity){j.stop(true);j.css("opacity",0);j.animate({opacity:1},{duration:d,queue:false})}});this.areHidden=false}},hideElements:function(d){if(!this.areHidden){var i=this,j;h.each(this.special.o,
function(f,n){j=i.items[n];if(d&&h.support.opacity){j.stop(true);j.animate({opacity:0},{duration:d,complete:function(){j.hide()},queue:false})}else j.hide()});this.areHidden=true}},setData:function(d){if(this.items.thumbs)this.thumbnailer.data=d;if(this.items.imager)this.imager.data=d},exitFullScreen:function(){!b.isFullScreen()&&this.config.isFullScreen&&this.fullscreen()},nativeFS:false,fullscreen:function(d){if(this.config.isFullScreen){if(this.config.useNativeFullScreen&&this.nativeFS){b.cancelFullScreen(this.$c[0]);
document.removeEventListener(b.fullScreenEventName,h.proxy(this.exitFullScreen,this))}else{h(window).unbind("resize",this.onFullResize);h.tn3unblock()}if(this.config.responsive!==false)this.initResponsive(this.config.responsive);else this.config.width!==null||this.config.height!==null?this.resize(this.config.width,this.config.height):this.resize(this.config.initValues.width,this.config.initValues.height);if(this.items.fullscreen){this.items.fullscreen.removeClass(this.config.cssID+"-fullscreen-active");
this.items.fullscreen.attr("title",this.t("Maximize"))}this.config.fullOnly&&this.$c.hide();this.config.isFullScreen=false;this.trigger("fullscreen",{fullscreen:false});this.config.keyNavigation=="fullscreen"&&h(document).unbind("keyup",this.listenKeys)}else{if(this.config.useNativeFullScreen&&d){document.addEventListener(b.fullScreenEventName,h.proxy(this.exitFullScreen,this),true);b.requestFullScreen(this.$c[0]);this.nativeFS=true}else{h.tn3block({message:this.$tn3,cssID:this.config.cssID});h(window).bind("resize",
h.proxy(this.onFullResize,this));this.nativeFS=false}this.config.fullOnly&&this.$c.show();this.config.isFullScreen=true;if(this.items.fullscreen){this.items.fullscreen.addClass(this.config.cssID+"-fullscreen-active");this.items.fullscreen.attr("title",this.t("Minimize"))}this.onFullResize();this.trigger("fullscreen",{fullscreen:true})}},listenKeys:function(d){if(d.keyCode==70)this.items.fullscreen.click();else if(this.items.albums&&this.albums.enabled){var i=0;switch(d.keyCode){case 27:this.albums.hide();
break;case 39:i="r";break;case 37:i="l";break;case 38:i="u";break;case 40:i="d";break;case 32:i="p"}i&&this.albums.select(i)}else switch(d.keyCode){case 27:this.config.isFullScreen&&this.fullscreen(true);break;case 39:this.show("next");break;case 37:this.show("prev");break;case 38:this.items.albums&&this.albums.show(0,this.cAlbum,false,true);break;case 32:this.items.play.click()}},onFullResize:function(){if(this.config.useNativeFullScreen&&this.nativeFS)this.resize(window.screen.width,window.screen.height);
else{var d=h(window),i=d.width();d=d.height();i-=this.config.initValues.wDif;d-=this.config.initValues.hDif;this.resize(i,d)}},resize:function(d,i){this.$tn3.width(d).height(i);var j=d-this.config.initValues.width,f=i-this.config.initValues.height,n,g,l=this;if(this.items.image){n=this.config.image.initValues.width+j;g=this.config.image.initValues.height+f;if(this.imager)this.imager.setSize(n,g);else{this.items.image.width(n).height(g);this.$inImage.width(n).height(g)}}if(this.items.thumbs){n=this.config.thumbnailer.initValues.width+
j;g=this.config.thumbnailer.initValues.height+f;if(this.thumbnailer)this.thumbnailer.setSize(n,g);else this.config.thumbnailer.initValues.vertical?this.items.thumbs.height(g):this.items.thumbs.width(n)}if(this.items.albums){n=this.albums.initValues.width+j;g=this.albums.initValues.height+f;this.albums.changeSize(j,f)}h.each(this.special.rh,function(k,m){l.items[m].width(l.config.initValues[m].w+j)});h.each(this.special.rv,function(k,m){l.items[m].height(l.config.initValues[m].h+f)});this.center()},
center:function(){var d,i=this,j=i.items.image.position();h.each(this.special.v,function(f,n){d=i.items[n];d.css("top",(d.parent().height()-d.height())/2)});h.each(this.special.h,function(f,n){d=i.items[n];d.css("left",(d.parent().width()-d.width())/2)});h.each(this.special.vi,function(f,n){d=i.items[n];d.css("top",j.top+(i.items.image.height()-d.height())/2)});h.each(this.special.hi,function(f,n){d=i.items[n];d.css("left",j.left+(i.items.image.width()-d.width())/2)});if(this.spinner){this.displayPreloader(true);
this.displayPreloader(false)}},trigger:function(d,i){var j=h.Event("tn3_"+d),f;for(f in i)j[f]=i[f];if(i&&i.type!=undefined)j.type="tn3_"+d;j.source=this;this.$c.trigger(j);this.config[d]&&this.config[d].call(this,j);for(f in i)i[f]=j[f];d=="timer_end"&&this.n==0&&this.trigger("autoplay_finish")},initMouseWheel:function(){var d=this,i=function(j){d.show((j.originalEvent.detail?-j.originalEvent.detail:j.originalEvent.wheelDelta)>0?"prev":"next");j.preventDefault()};this.$tn3.bind("mousewheel",i);this.$tn3.bind("DOMMouseScroll",
i)},initResponsive:function(d){var i;if(typeof d=="number"){var j=h(window);i=function(){var t=j.width(),u=j.height();this.resize(t*d/100,u*d/100)}}else if(h.isFunction(d))i=d;else if(d!==false){var f=this.$c.parent(),n=(this.config.width==null?this.config.initValues.width:this.config.width)/(this.config.height==null?this.config.initValues.height:this.config.height),g=f.width(),l=f.height();i=d=="enabled"?function(){g=f.width();l=f.height();this.resize(g,l)}:d=="height"?function(){l=f.height();g=
l*n;this.resize(g,l)}:function(){g=f.width();l=g/n;this.resize(g,l)}}var k=this,m=function(){if(k.config.useNativeFullScreen)k.config.isFullScreen||h.proxy(i,k)();else h.proxy(i,k)()};h(window).bind("resize",m);m()},replaceMenu:function(d,i){var j='<div style="position:absolute;background-color:#fff;color: #000;padding:0px 4px 0px 4px;z-index:1010;font-family:sans-serif;font-size:12px;">&copy; <a href="'+i+'">'+d+"</a></div>";this.$tn3.bind("contextmenu",function(f){f.preventDefault()}).bind("mousedown",
function(f){if(f.which==3){var n=h(j);h("body").append(n);n.css("left",f.pageX).css("top",f.pageY);n.find("a").mouseup(function(g){window.location=i;n.unbind(g)});h("body").mouseup(function(g){n.remove();h("body").unbind(g)})}})},imageEnter:function(){this.config.timerOverStop&&this.timer.pause(true);this.special.o.length>0&&this.showElements(this.config.overFadeDuration)},imageLeave:function(){this.config.timerOverStop&&this.timer.pause(false);this.special.o.length>0&&this.hideElements(this.config.overFadeDuration)},
displayPreloader:function(d){if(this.items.preloader)if(d){this.items.preloader.show();if(this.config.spinjs)if(this.spinner)this.spinner.spin(this.items.preloader[0]);else this.spinner=(new Spinner(this.config.spinjs)).spin(this.items.preloader[0])}else{this.spinner&&this.spinner.stop();this.items.preloader.hide()}}};var b={supportsFullScreen:false,isFullScreen:function(){return false},requestFullScreen:function(){},cancelFullScreen:function(){},fullScreenEventName:"",prefix:""},a="webkit moz o ms khtml".split(" ");
if(typeof document.cancelFullScreen!="undefined")b.supportsFullScreen=true;else for(var c=0,e=a.length;c<e;c++){b.prefix=a[c];if(typeof document[b.prefix+"CancelFullScreen"]!="undefined"){b.supportsFullScreen=true;break}}if(b.supportsFullScreen){b.fullScreenEventName=b.prefix+"fullscreenchange";b.isFullScreen=function(){switch(this.prefix){case "":return document.fullScreen;case "webkit":return document.webkitIsFullScreen;default:return document[this.prefix+"FullScreen"]}};b.requestFullScreen=function(d){return this.prefix===
""?d.requestFullScreen():d[this.prefix+"RequestFullScreen"]()};b.cancelFullScreen=function(){return this.prefix===""?document.cancelFullScreen():document[this.prefix+"CancelFullScreen"]()}}})(jQuery);
(function(h,b,a){function c(q,p){var r=b.createElement(q||"div"),s;for(s in p)r[s]=p[s];return r}function e(q){for(var p=1,r=arguments.length;p<r;p++)q.appendChild(arguments[p]);return q}function d(q,p,r,s){var v=["opacity",p,~~(q*100),r,s].join("-");r=0.01+r/s*100;s=Math.max(1-(1-q)/p*(100-r),q);var w=k.substring(0,k.indexOf("Animation")).toLowerCase();w=w&&"-"+w+"-"||"";return l[v]||(m.insertRule("@"+w+"keyframes "+v+"{0%{opacity:"+s+"}"+r+"%{opacity:"+q+"}"+(r+0.01)+"%{opacity:1}"+(r+p)%100+"%{opacity:"+
q+"}100%{opacity:"+s+"}}",m.cssRules.length),l[v]=1),v}function i(q,p){var r=q.style,s,v;if(r[p]!==a)return p;p=p.charAt(0).toUpperCase()+p.slice(1);for(v=0;v<g.length;v++){s=g[v]+p;if(r[s]!==a)return s}}function j(q,p){for(var r in p)q.style[i(q,r)||r]=p[r];return q}function f(q){for(var p=1;p<arguments.length;p++){var r=arguments[p],s;for(s in r)q[s]===a&&(q[s]=r[s])}return q}function n(q){for(var p={x:q.offsetLeft,y:q.offsetTop};q=q.offsetParent;){p.x+=q.offsetLeft;p.y+=q.offsetTop}return p}var g=
...
undefined)){this.cached[c]={isImage:true,status:"loading",init:a};this.currentlyLoading=c;if(this.data[c].content!=undefined){this.cached[c].isImage=false;this.onCacheLoad(h(h.trim(this.data[c].content)),c)}else this.cached[c].loader=new h.fn.tn3.ImageLoader(this.data[c].img,this,this.onCacheLoad,[c])}},onCacheLoad:function(b,a,c){this.cached[a].status="loaded";this.cached[a].isImage&&b.attr("alt",this.data[a].alt);this.cached[a].$content=b;c&&this.trigger("error",{description:c,n:a});this.cached[a].init&&
...
doTransition:c});c[0]&&this.initTransition()},initTransition:function(){this.$buffer.css("visibility","visible");if(this.$active!=false){this.isInTransition=true;this.unbindMouseEvents();if(this.mouseIsOver)h(document).mousemove(h.proxy(this.onMouseMove,this));else this.mouseCoor={x:0,y:0};this.lastEnter="leave";this.ts.start(this.$active,this.$buffer,this.side)}else{this.$active=this.$buffer;this.trigger("transition",{n:this.active})}this.startLoading(this.side=="right"?"prev":"next",false)},setSize:function(b,
...
b.data("scaled",false);var a=$img.width(),c=$img.height(),e=0,d=0,i={w:a,h:c,left:0,top:0};$img.attr("width",a).attr("height",c);if($img.get(0).tagName.toUpperCase()=="IMG"&&(a!=this.cDim.w||c!=this.cDim.h)){e=this.cDim.w/a;d=this.cDim.h/c;e=this.config.crop?Math.max(e,d):Math.min(e,d);e=Math.min(this.config.maxZoom,e);a=i.w=Math.round(a*e)-this.config.dif;c=i.h=Math.round(c*e)-this.config.dif;if(this.cDim.w>=a)e=i.left=(this.cDim.w-a)/2;else{e=-(a-this.cDim.w)*0.5;i.w=this.cDim.w}if(this.cDim.h>
c)d=i.top=(this.cDim.h-c)/2;else{d=-(c-this.cDim.h)*0.5;i.h=this.cDim.h}$img.width(a).height(c);$img.attr("width",a).attr("height",c);$ic.width(a).height(c);b.data("scaled",true)}$ic.css("left",e).css("top",d);this.bindMouseEvents($ic);this.trigger("resize",i)},resizeContent:function(b){$ic=b.data("ic");$img=b.data("img");b.data("scaled",false);var a=$img.width(),c=$img.height(),e={w:a,h:c,left:0,top:0};if(this.config.stretch){$ic.width(this.cDim.w).height(this.cDim.h);$img.width(this.cDim.w).height(this.cDim.h);
b.data("scaled",true)}else{e.left=(this.cDim.w-a)*0.5;e.top=(this.cDim.h-c)*0.5;$ic.css("left",e.left).css("top",e.top)}this.bindMouseEvents($ic);this.trigger("resize",e)},onTransitionEnd:function(){this.$active.remove();this.$active=this.$buffer;this.$active.css("width","+=1");this.isInTransition=false;this.trigger("transition",{n:this.active});this.bindMouseEvents(this.$binder);var b=this.$binder.offset();this.mouseIsOver=false;if(this.mouseCoor.x>=b.left&&this.mouseCoor.x<=b.left+this.$binder.width())if(this.mouseCoor.y>=
b.top&&this.mouseCoor.y<=b.top+this.$binder.height()){this.lastEnter="leave";this.enterLeave("enter");this.startIdle();this.mouseIsOver=true;h(document).mousemove(h.proxy(this.onMouseMove,this))}this.qid!=null&&this.show(this.qid)},trigger:function(b,a){var c=h.Event("img_"+b),e;for(e in a)c[e]=a[e];c.source=this;this.$c.trigger(c);this.config[b]&&this.config[b].call(this,c)},destroy:function(){this.isInTransition&&this.ts.stop(this.$active,this.$buffer);this.$active&&this.$active.remove();this.$buffer.remove()},
...
(function(h){function b(g){var l=g&&g.message!==undefined?g.message:undefined;g=h.extend({},h.tn3block.defaults,g||{});l=l===undefined?g.message:l;n&&a({});var k=g.baseZ,m=i||g.forceIframe?h('<iframe class="blockUI" style="z-index:'+k++ +';display:none;border:none;margin:0;padding:0;position:absolute;width:100%;height:100%;top:0;left:0" src="'+g.iframeSrc+'"></iframe>'):h('<div class="blockUI" style="display:none"></div>'),t=h('<div class="blockUI '+g.cssID+'-overlay" style="z-index:'+k++ +';display:none;border:none;margin:0;padding:0;width:100%;height:100%;top:0;left:0"></div>');
k=h('<div class="blockUI '+g.blockMsgClass+' blockPage" style="z-index:'+k+';display:none;position:fixed"></div>');k.css("left","0px").css("top","0px");t.css(g.overlayCSS);t.css("position","fixed");if(i||g.forceIframe)m.css("opacity",0);var u=[m,t,k],q=h("body");h.each(u,function(){this.appendTo(q)});u=f&&(!h.boxModel||h("object,embed",null).length>0);if(j||u){g.allowBodyStretch&&h.boxModel&&h("html,body").css("height","100%");h.each([m,t,k],function(p,r){var s=r[0].style;s.position="absolute";if(p<
