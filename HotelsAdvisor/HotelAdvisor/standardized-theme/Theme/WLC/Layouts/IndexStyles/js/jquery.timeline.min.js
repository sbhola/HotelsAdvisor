(function (e) {
    var t = {init: function (t) {
        var n = e.extend({itemClass: ".item", itemOpenClass: ".item_open", openTriggerClass: ".item", closeText: "Close", itemMargin: 10, scrollSpeed: 500, startItem: "last", easing: "easeOutSine", categories: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], nuberOfSegments: [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], yearsOn: true, swipeOn: true, hideTimeline: false, hideControles: false, closeItemOnTransition: false, ajaxFailMessage: "Ajax request has failed."}, t);
        var r = this, i = e("body"), s = r.find(n.itemClass), o = r.find(n.itemOpenClass), u = s.first().width(), a = o.first().width(), f = n.closeItemOnTransition;
        ...
        r.css({width: "100%", overflow: "hidden", marginLeft: "auto", marginRight: "auto", "text-align": "center", height: 0});
        ...
        r.find(".timeline_items_holder").css({width: "300px", marginLeft: "auto", marginRight: "auto"});
        s.css({paddingLeft: 0, paddingRight: 0, marginLeft: n.itemMargin / 2, marginRight: n.itemMargin / 2, "float": "left", position: "relative"});
        o.each(function () {
            e(this).prepend('<div class="t_close" data-count="' + e(this).attr("data-count") + '" data-id="' + e(this).attr("data-id") + '">' + n.closeText + "</div>");
            e(this).wrapInner('<div class="' + n.itemOpenClass.substr(1) + '_cwrapper"  />').find("div:first").css({position: "relative"});
            e(this).css({width: 0, padding: 0, margin: 0, "float": "left", display: "none", position: "relative", overflow: "hidden"})
        });
        var c = r.find(".timeline_items:first"), h = r.find(".t_line_wrapper:first"), p = 300 / 2 - (u + n.itemMargin) * (1 / 2 + l), d = (u + n.itemMargin) * s.length + (a + n.itemMargin) + 660, v = r.data("timeline");
        c.css({width: d, marginLeft: p});
        if (!v) {
            r.data("timeline", {currentIndex: l, itemCount: s.length, margin: p, itemWidth: u, itemOpenWidth: a, lineMargin: 0, lineViewCount: 0, options: n, items: s, iholder: c, open: false, noAnimation: false, marginResponse: false, mousedown: false, mousestartpos: 0})
        }
        if (!n.hideTimeline) {
        ...
        e(document).ready(function () {
            r.find(n.itemClass).css({"-webkit-touch-callout": "none", "-webkit-user-select": "none", "-khtml-user-select": "none", "-moz-user-select": "none", "-ms-user-select": "none", "user-select": "none"}).find("img").on("dragstart", function (t) {
        ...
        e(window).resize(function () {
            var t = r.data("timeline"), i = s.eq(t.currentIndex).attr("data-id");
        ...
        if (n.swipeOn) {
            s.find("*").each(function () {
                e(this).css({"-webkit-touch-callout": "none", "-webkit-user-select": "none", "-khtml-user-select": "none", "-moz-user-select": "none", "-ms-user-select": "none", "user-select": "none"})
            });
        ...
        t.bind("touchmove", function (e) {
            var t = e.originalEvent.touches[0].pageX, i = e.originalEvent.touches[0].pageY;
        ...
        var n = this, r = n.data("timeline"), i = 0;
        r.mousedown = true;
        r.mousestartpos = t;
        ...
        var t = this, n = t.data("timeline"), r = n.itemWidth + n.options.itemMargin, i = n.currentIndex, s = 0, o = e - n.mousestartpos;
        ...
        var n = this, r = n.data("timeline"), i = r.itemWidth + r.options.itemMargin, s = r.currentIndex, o = 0, u = t - r.mousestartpos;
        r.mousedown = false;
        ...
        var r = this, i = r.data("timeline"), s = r.find(i.options.itemOpenClass), o = i.options.scrollSpeed, u = i.itemOpenWidth, a = i.options.easin, f = i.options.itemMargin;
        s.each(function () {
            if (e(this).attr("data-id") == t) {
                if (!n || n == e(this).attr("data-count")) {
                    var s = e(this);
                    r.trigger("itemOpen.Timeline");
                    e(this).stop(true).show().animate({width: u, marginLeft: f / 2, marginRight: f / 2}, o, a);
                    ...
                    i.iholder.stop(true).animate({marginLeft: i.margin}, o, a);
                    i.open = t
                }
            }
        });
        ...
        var i = this, s = i.data("timeline"), o = i.find(s.options.itemOpenClass), u = s.options.scrollSpeed, a = s.itemOpenWidth, f = s.options.easing;
        o.each(function () {
            if (e(this).attr("data-id") == t && e(this).is(":visible")) {
                i.trigger("itemClose.Timeline");
                e(this).stop(true).animate({width: 0, margin: 0}, u, f, function () {
                    e(this).hide()
                });
                if (s.marginResponse) {
                ...
                s.iholder.stop(true).animate({marginLeft: s.margin}, u, f);
                s.open = false
            }
        });
        if (n) {
        ...
        var e = this, t = e.data("timeline"), n = t.options.scrollSpeed, r = t.options.easing;
        if (t.currentIndex < t.itemCount - 1) {
            ...
            t.iholder.stop(true).animate({marginLeft: t.margin - 50}, n / 2, r).animate({marginLeft: t.margin}, n / 2, r)
        }
        return e
    }, left: function () {
        var e = this, t = e.data("timeline"), n = t.options.scrollSpeed, r = t.options.easing;
        ...
        var i = this, s = i.data("timeline"), o = s.options.scrollSpeed, u = s.options.easing, a = s.items, f = i.find(".timeline_line").width(), l = -1, c = false;
        a.each(function (r) {
        ...
        if (c) {
            ...
            if (s.noAnimation) {
                s.noAnimation = false;
                i.find(".t_line_wrapper").stop(true).css({marginLeft: s.lineMargin + "%"})
            } else {
                i.find(".t_line_wrapper").stop(true).animate({marginLeft: s.lineMargin + "%"}, o, u)
            }
            if (s.open) {
            ...
            s.iholder.stop(true).animate({marginLeft: s.margin}, o + o / 5 * (Math.abs(d) - 1), u, function () {
        ...
        if (t.lineMargin != 0 && t.options.categories) {
            t.lineMargin += 100;
            e.find(".t_line_wrapper").stop(true).animate({marginLeft: t.lineMargin + "%"}, n, r)
        }
    }, lineRight: function () {
        var e = this, t = e.data("timeline"), n = t.options.scrollSpeed, r = t.options.easing;
        if (e.find(".t_line_view:first").width() > e.find(".timeline_line").width())var i = t.lineViewCount * 2; else var i = t.lineViewCount;
        if (t.lineMargin != -(i - 1) * 100 && t.options.categories) {
            t.lineMargin -= 100;
            e.find(".t_line_wrapper").stop(true).animate({marginLeft: t.lineMargin + "%"}, n, r)
        }
    }, createElements: function () {
        var t = this, n = t.data("timeline"), r = n.items;
        var i = "\n" + '    <div class="timeline_line" style="text-align: left; position:relative; margin-left:auto; margin-right:auto;">\n' + "	 </div>\n";
        t.prepend(i);
        var s = t.find(".timeline_line").width(), o = new Array, u = [""].concat(n.options.categories);
        ...
        if (!n.options.categories) {
            r.each(function () {
                var t = e(this).attr("data-id"), n = t.split("/"), r = parseInt(n[0], 10), i = e.inArray(n[1], u) != -1 ? e.inArray(n[1], u) : parseInt(n[1], 10), s = parseInt(n[2], 10);
                if (r < minY)minY = r;
                if (r > maxY)maxY = r
            });
            minY -= 10;
        ...
        r.each(function (t) {
            var r = e(this).attr("data-id"), i = e(this).attr("data-name"), s = e(this).attr("data-description"), f = r.split("/"), l = parseInt(f[0], 10), c = e.inArray(f[1], u) != -1 ? e.inArray(f[1], u) : parseInt(f[1], 10), h = parseInt(f[2], 10);
            ...
            //o[r] = '<a href="#' + r + '" class="t_line_node' + p + '" style="text-align:center;">' + v;
