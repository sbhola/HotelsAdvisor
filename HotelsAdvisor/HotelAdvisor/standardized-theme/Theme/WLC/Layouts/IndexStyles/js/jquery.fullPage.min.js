...
(function (a) {
    a.fn.fullpage = function (c) {
        function $(b) {
            ...
            if (!L(b.target) && (b = a(".section.active"), !t && !s))if (e = M(e), w = e.y, A = e.x, b.find(".slides").length && Math.abs(B - A) > Math.abs(x - w))Math.abs(B - A) > a(window).width() / 100 * c.touchSensitivity && (B > A ? a.fn.fullpage.moveSlideRight() : a.fn.fullpage.moveSlideLeft()); else if (c.autoScrolling && (e = b.find(".slides").length ? b.find(".slide.active").find(".scrollable") : b.find(".scrollable"), Math.abs(x - w) > a(window).height() /
                100 * c.touchSensitivity))if (x > w)if (0 < e.length)if (C("bottom", e))a.fn.fullpage.moveSectionDown(); else return!0; else a.fn.fullpage.moveSectionDown(); else if (w > x)if (0 < e.length)if (C("top", e))a.fn.fullpage.moveSectionUp(); else return!0; else a.fn.fullpage.moveSectionUp()
        }
        ...
        function n(b) {
            if (c.autoScrolling) {
                ...
                var e;
                e = a(".section.active");
                if (!t)if (e = e.find(".slides").length ? e.find(".slide.active").find(".scrollable") : e.find(".scrollable"), 0 > b)if (0 < e.length)if (C("bottom", e))a.fn.fullpage.moveSectionDown(); else return!0; else a.fn.fullpage.moveSectionDown(); else if (0 < e.length)if (C("top", e))a.fn.fullpage.moveSectionUp(); else return!0; else a.fn.fullpage.moveSectionUp();
                return!1
            }
        }
        ...
        function N(b) {
            ...
            if (e.length && !s) {
                ...
                if (!f.length) {
                    ...
                    f = "prev" === b ? d.siblings(":last") : d.siblings(":first")
                }
                s = !0;
                p(e, f)
            }
        ...
        function h(b, e, d) {
            ...
            if ("undefined" !== typeof g) {
                ...
                if (c.autoScrolling && c.continuousVertical &&
                    "undefined" !== typeof d && (!d && "up" == l || d && "down" == l)) {
                ...
                c.css3 && c.autoScrolling ? (a.isFunction(c.onLeave) && !E && c.onLeave.call(this, s, y + 1, l), P("translate3d(0px, -" + g + "px, 0px)", !0), setTimeout(function () {
                    m();
                    a.isFunction(c.afterLoad) && !E && c.afterLoad.call(this, q, y + 1);
                    setTimeout(function () {
                        t = !1;
                        a.isFunction(e) && e.call(this)
                    }, Q)
                }, c.scrollingSpeed)) : (a.isFunction(c.onLeave) && !E && c.onLeave.call(this, s, y + 1, l), a(b).animate(f, c.scrollingSpeed, c.easing, function () {
                    m();
                    a.isFunction(c.afterLoad) && !E && c.afterLoad.call(this, q,
                            y + 1);
                    setTimeout(function () {
                        t = !1;
                        a.isFunction(e) && e.call(this)
        ...
        function p(b, e) {
            ...
            if (c.onSlideLeave) {
                var n = l.find(".slide.active").index(), p;
                p = n == g ? "none" : n > g ? "left" : "right";
                m || a.isFunction(c.onSlideLeave) && c.onSlideLeave.call(this, h, q + 1, n, p)
            }
            e.addClass("active").siblings().removeClass("active");
            "undefined" === typeof r && (r = g);
            l.hasClass("active") && (c.loopHorizontal || (l.find(".controlArrow.prev").toggle(0 != g), l.find(".controlArrow.next").toggle(!e.is(":last-child"))), O(g, r, h));
            c.css3 ? (d = "translate3d(-" + d.left + "px, 0px, 0px)", b.find(".slidesContainer").toggleClass("easing", 0 < c.scrollingSpeed).css(T(d)), setTimeout(function () {
                m || a.isFunction(c.afterSlideLoad) && c.afterSlideLoad.call(this, h, q + 1, r, g);
                s = !1
            }, c.scrollingSpeed, c.easing)) : f.animate({scrollLeft: d.left}, c.scrollingSpeed, c.easing, function () {
                m ||
                    a.isFunction(c.afterSlideLoad) && c.afterSlideLoad.call(this, h, q + 1, r, g);
                s = !1
            });
        ...
        function U() {
            ...
            a(".section").each(function () {
                ...
                b.length && p(b, b.find(".slide.active"))
            });
        ...
        function ba(b, c) {
            var d = 825, f = b;
            825 > b || 900 > c ? (900 > c && (f = c, d = 900), d = (100 * f / d).toFixed(2), a("body").css()) : a("body").css()
            //825 > b || 900 > c ? (900 > c && (f = c, d = 900), d = (100 * f / d).toFixed(2), a("body").css("font-size", d + "%")) : a("body").css("font-size", "100%")
        }

        function S(b, e) {
            c.navigation && (a("#fullPage-nav").find(".active").removeClass("active"),
                b ? a("#fullPage-nav").find('a[href="#' + b + '"]').addClass("active") : a("#fullPage-nav").find("li").eq(e).find("a").addClass("active"))
        }
        ...
        function F(b) {
            ...
            if (d.length)var f = b.find(".scrollable").get(0).scrollHeight; else f = b.get(0).scrollHeight, c.verticalCentered && (f = b.find(".tableCell").get(0).scrollHeight);
            a = k - parseInt(a.css("padding-bottom")) - parseInt(a.css("padding-top"));
            f > a ? d.length ? d.css("height", a + "px").parent().css("height", a + "px") : (c.verticalCentered ? b.find(".tableCell").wrapInner('<div class="scrollable" />') : b.wrapInner('<div class="scrollable" />'), b.find(".scrollable").slimScroll({height: a +
                "px", size: "10px", alwaysVisible: !0})) : (b.find(".scrollable").children().first().unwrap().unwrap(), b.find(".slimScrollBar").remove(), b.find(".slimScrollRail").remove());
            b.css("overflow", "")
        }
        ...
        function V(b) {
            var a = k;
            if (c.paddingTop || c.paddingBottom)a = b, a.hasClass("section") || (a = b.closest(".section")), b = parseInt(a.css("padding-top")) + parseInt(a.css("padding-bottom")), a = k - b;
            return a
        }

        function P(b, a) {
            u.toggleClass("easing",
                a);
            u.css(T(b))
        }
        ...
        function ca(b, a) {
            ...
            for (var f = 0; f < a; f++)d.find("ul").append('<li><a href="#"><span></span></a></li>');
        ...
        function O(b, a, d) {
            var f = "";
            c.anchors.length && (b ? ("undefined" !== typeof d && (f = d), "undefined" === typeof a && (a = b), J = a, location.hash = f + "/" + a) : ("undefined" !== typeof b && (J = a), location.hash = d))
        }

        function da() {
            var b = document.createElement("p"), a, c = {webkitTransform: "-webkit-transform", OTransform: "-o-transform", msTransform: "-ms-transform", MozTransform: "-moz-transform", transform: "transform"};
        ...
        function T(a) {
            return{"-webkit-transform": a, "-moz-transform": a, "-ms-transform": a,
                transform: a}
        }

        c = a.extend({verticalCentered: !0, resize: !0, slidesColor: [], anchors: [], scrollingSpeed: 700, easing: "easeInQuart", menu: !1, navigation: !1, navigationPosition: "right", navigationColor: "#000", navigationTooltips: [], slidesNavigation: !1, slidesNavPosition: "bottom", controlArrowColor: "#fff", loopBottom: !1, loopTop: !1, loopHorizontal: !0, autoScrolling: !0, scrollOverflow: !1, css3: !1, paddingTop: 0, paddingBottom: 0, fixedElements: null, normalScrollElements: null, keyboardScrolling: !0, touchSensitivity: 5, continuousVertical: !1,
            animateAnchor: !0, normalScrollElementTouchThreshold: 5, afterLoad: null, onLeave: null, afterRender: null, afterResize: null, afterSlideLoad: null, onSlideLeave: null}, c);
        ...
        a.fn.fullpage.setAutoScrolling = function (b) {
            c.autoScrolling = b;
            b = a(".section.active");
            c.autoScrolling ? (a("html, body").css({overflow: "hidden",
                height: "100%"}), b.length && z(b.position().top)) : (a("html, body").css({overflow: "auto", height: "auto"}), z(0), a("html, body").scrollTop(b.position().top))
        };
        a.fn.fullpage.setScrollingSpeed = function (a) {
            c.scrollingSpeed = a
        };
        a.fn.fullpage.setMouseWheelScrolling = function (a) {
            a ? document.addEventListener ? (document.addEventListener("mousewheel", n, !1), document.addEventListener("wheel", n, !1)) : document.attachEvent("onmousewheel", n) : document.addEventListener ? (document.removeEventListener("mousewheel", n, !1), document.removeEventListener("wheel",
                n, !1)) : document.detachEvent("onmousewheel", n)
        };
        a.fn.fullpage.setAllowScrolling = function (b) {
            b ? (a.fn.fullpage.setMouseWheelScrolling(!0), G && (a(document).off("touchstart MSPointerDown").on("touchstart MSPointerDown", aa), a(document).off("touchmove MSPointerMove").on("touchmove MSPointerMove", $))) : (a.fn.fullpage.setMouseWheelScrolling(!1), G && (a(document).off("touchstart MSPointerDown"), a(document).off("touchmove MSPointerMove")))
        };
        a.fn.fullpage.setKeyboardScrolling = function (a) {
            c.keyboardScrolling = a
        };
        var s =
            !1, G = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|Windows Phone|Tizen|Bada)/), u = a(this), k = a(window).height(), t = !1, D = !1, v, J;
        a.fn.fullpage.setAllowScrolling(!0);
        c.css3 && (c.css3 = da());
        a(this).length ? u.css({height: "100%", position: "relative", "-ms-touch-action": "none"}) : (a("body").wrapInner('<div id="superContainer" />'), u = a("#superContainer"));
        if (c.navigation) {
        ...
        a(".section").each(function (b) {
            var e =
                a(this), d = a(this).find(".slide"), f = d.length;
            ...
            if (1 < f) {
                ...
                a(this).find(".slides").after('<div class="controlArrow prev wlc-icon-prev"></div><div class="controlArrow next wlc-icon-nxt"></div>');
                ...
                c.slidesNavigation && ca(a(this), f);
                d.each(function (b) {
                    b || 0 != e.find(".slide.active").length || a(this).addClass("active");
                    a(this).css("width", h + "%");
            ...
            if (b.length && (0 != a(".section.active").index(".section") || 0 == a(".section.active").index(".section") && 0 != b.index())) {
                ...
                p(a(".section.active").find(".slides"), b);
                a.fn.fullpage.setScrollingSpeed(e)
            }
            c.fixedElements && c.css3 && a(c.fixedElements).appendTo("body");
            c.navigation && (m.css("margin-top", "-" + m.height() / 2 + "px"), m.find("li").eq(a(".section.active").index(".section")).find("a").addClass("active"));
            c.menu && c.css3 && a(c.menu).appendTo("body");
            if (c.scrollOverflow)a(window).on("load",
                function () {
                    a(".section").each(function () {
                        var b = a(this).find(".slide");
                        b.length ? b.each(function () {
                ...
                }); else a.isFunction(c.afterRender) && c.afterRender.call(this);
            b = window.location.hash.replace("#", "").split("/")[0];
            b.length && (e = a('[data-anchor="' + b + '"]'), !c.animateAnchor && e.length && (z(e.position().top), a.isFunction(c.afterLoad) && c.afterLoad.call(this, b, e.index(".section") + 1), e.addClass("active").siblings().removeClass("active")));
        ...
        a(window).scroll(function (b) {
            if (!c.autoScrolling) {
                ...
                b = a(".section").map(function () {
                    if (a(this).offset().top < e + 100)return a(this)
                });
                b = b[b.length - 1];
                if (!b.hasClass("active")) {
                    ...
                    b.addClass("active").siblings().removeClass("active");
                    var g = b.data("anchor");
                    a.isFunction(c.onLeave) && c.onLeave.call(this,
                        d, b.index(".section") + 1, f);
        ...
        a.fn.fullpage.moveSectionDown = function () {
            ...
            b.length ||
                !c.loopBottom && !c.continuousVertical || (b = a(".section").first());
        ...
        a(window).on("hashchange", function () {
            if (!K) {
                var a = window.location.hash.replace("#", "").split("/"), c = a[0], a =
                    a[1], d = "undefined" === typeof v, f = "undefined" === typeof v && "undefined" === typeof a;
